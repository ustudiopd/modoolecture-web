...
export default function QuestionCard({ question, onVote, voted = false }: QuestionCardProps) {
        ...
        <div className="flex gap-4 text-sm text-slate-500">
          <button
            ...
            className={cn(
              ...
              voted ? 'text-purple-400' : 'hover:text-purple-400'
            )}
          >
